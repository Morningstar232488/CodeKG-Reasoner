...
#Rule 1
def compute_block_pass_k(answer:str, model_output:list, k:int, model_filled_code, core_line_in_core_block, core_line_in_output_clear):
...
def compute_line_pass_k(answer:str, model_output:list, k:int):
...
if task == 'line':
    ...
    for data in data_list:
        ...
        score_p_list.append(compute_line_pass_k(answer,model_output,k))
    ...
    for data in data_list:
        ...
        score_p_list.append(compute_block_pass_k(answer, model_output, k, model_filled_code, core_line_in_core_block, core_line_in_output_clear))
