...
if __name__ == '__main__':
    ...
    mode = 'old' if edit_order == 'new_to_old' else 'new'

    k = 1
    result_path = f'../../data_to_test/{model_name}/{index}/code_migration_exe_{edit_order}.json'
    ...
    for d in data_list:
        ...
        core_token = d[f'{mode}_core_token']
