...
if __name__ == '__main__':
    ...
    mode = 'new' if edit_order == 'old_to_new' else 'old'
    block_json_path = f'../../data_to_test/{model_name}/{index}/code_migration_exe_{edit_order}.json'
    ...
    for data in data_list:
        # k设为1的话，就只要第一个[:1]
        model_output_list = data['model_output_clear'][:1]
